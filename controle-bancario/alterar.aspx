<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="alterar.aspx.cs" Inherits="controle_bancario.alterar" %>
...
<body>
    ...
    <asp:Button ID="atualiza" runat="server" text="Aualizar" CssClass="btn btn-cadastrar font-primary-bold_mediun" OnClick="atualiza_Click" />
    </form>
    <%		   
